...
def ConvFactory(data, num_filter, kernel, stride=(1,1), pad=(0, 0), name=None, suffix=''):
    ...
    bn = mx.symbol.BatchNorm(data=conv, name='bn_%s%s' %(name, suffix), momentum=0.1, eps=1e-10)
...
def get_symbol(num_classes=1000):
    ...
    # stage 2
    conv2red = mx.symbol.Convolution(data=pool1, num_filter=64, kernel=(1, 1), stride=(1, 1), pad=(0, 0), name='conv_2_reduce')
    bn2red = mx.symbol.BatchNorm(data=conv2red, name='bn_2_1', momentum=0.1, eps=1e-10)
    act2red = mx.symbol.Activation(data=bn2red, act_type='relu', name='relu_2_1')
    conv2 = ConvFactory(data=act2red, num_filter=192, kernel=(3, 3), stride=(1, 1), pad=(1, 1), name='2')
