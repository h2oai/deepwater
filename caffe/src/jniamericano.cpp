...
static const char* JavaCPP_classNames[22] = {
        ...
        "org/bytedeco/javacpp/americano$FloatNCCL",
        "org/bytedeco/javacpp/americano$Barrier",
        "org/bytedeco/javacpp/americano$NCCLVector" };
...
static void JavaCPP_org_bytedeco_javacpp_americano_00024FloatNCCL_deallocate(void *p) { delete (::caffe::FloatNCCL*)p; }
static void JavaCPP_org_bytedeco_javacpp_americano_00024Barrier_deallocate(void *p) { delete (::caffe::Barrier*)p; }
static void JavaCPP_org_bytedeco_javacpp_americano_00024NCCLVector_deallocate(void *p) { delete (::std::vector<caffe::FloatNCCL*>*)p; }
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    int offsets[22][1] = {
            ...
            { -1 },
            { -1 },
            { sizeof(::caffe::FloatNCCL) },
            { sizeof(::caffe::Barrier) },
            { sizeof(::std::vector<caffe::FloatNCCL*>) } };
...
JNIEXPORT void JNICALL Java_org_bytedeco_javacpp_americano_00024FloatNCCL_Broadcast(JNIEnv* env, jobject obj) {
    ::caffe::FloatNCCL* ptr = (::caffe::FloatNCCL*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 17), "This pointer address is NULL.");
        return;
    }
...
JNIEXPORT void JNICALL Java_org_bytedeco_javacpp_americano_00024FloatNCCL_InitSingleProcess(JNIEnv* env, jclass cls, jobject arg0) {
    ::std::vector<caffe::FloatNCCL*>* ptr0 = arg0 == NULL ? NULL : (::std::vector<caffe::FloatNCCL*>*)jlong_to_ptr(env->GetLongField(arg0, JavaCPP_addressFID));
    if (ptr0 == NULL) {
    ...
    jthrowable exc = NULL;
    try {
        ::caffe::FloatNCCL::InitSingleProcess(*(const ::std::vector<caffe::FloatNCCL*>*)ptr0);
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
...
JNIEXPORT void JNICALL Java_org_bytedeco_javacpp_americano_00024FloatNCCL_allocate(JNIEnv* env, jobject obj, jobject arg0, jobject arg1) {
    ::caffe::Solver<float>* ptr0 = arg0 == NULL ? NULL : (::caffe::Solver<float>*)jlong_to_ptr(env->GetLongField(arg0, JavaCPP_addressFID));
    jlong size0 = arg0 == NULL ? 0 : env->GetLongField(arg0, JavaCPP_limitFID);
    void* owner0 = JavaCPP_getPointerOwner(env, arg0);
    jlong position0 = arg0 == NULL ? 0 : env->GetLongField(arg0, JavaCPP_positionFID);
    ptr0 += position0;
    size0 -= position0;
    SharedPtrAdapter< ::caffe::Solver<float> > adapter0(ptr0, size0, owner0);
    ::caffe::Barrier* ptr1 = arg1 == NULL ? NULL : (::caffe::Barrier*)jlong_to_ptr(env->GetLongField(arg1, JavaCPP_addressFID));
    jlong position1 = arg1 == NULL ? 0 : env->GetLongField(arg1, JavaCPP_positionFID);
    ptr1 += position1;
    jthrowable exc = NULL;
    try {
        ::caffe::FloatNCCL* rptr = new ::caffe::FloatNCCL(adapter0, ptr1);
        jlong rcapacity = 1;
        JavaCPP_initPointer(env, obj, rptr, rcapacity, rptr, &JavaCPP_org_bytedeco_javacpp_americano_00024FloatNCCL_deallocate);
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }

    ::caffe::Solver<float>* rptr0 = adapter0;
    jlong rsize0 = (jlong)adapter0.size;
    void* rowner0 = adapter0.owner;
    if (rptr0 != ptr0) {
        JavaCPP_initPointer(env, arg0, rptr0, rsize0, rowner0, &SharedPtrAdapter< ::caffe::Solver<float> >::deallocate);
    } else {
...
JNIEXPORT void JNICALL Java_org_bytedeco_javacpp_americano_00024Barrier_Wait(JNIEnv* env, jobject obj) {
    ::caffe::Barrier* ptr = (::caffe::Barrier*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 17), "This pointer address is NULL.");
        return;
    }
...
JNIEXPORT void JNICALL Java_org_bytedeco_javacpp_americano_00024Barrier_allocate(JNIEnv* env, jobject obj, jint arg0) {
    jthrowable exc = NULL;
    try {
        ::caffe::Barrier* rptr = new ::caffe::Barrier(arg0);
        jlong rcapacity = 1;
        JavaCPP_initPointer(env, obj, rptr, rcapacity, rptr, &JavaCPP_org_bytedeco_javacpp_americano_00024Barrier_deallocate);
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
...
JNIEXPORT jobject JNICALL Java_org_bytedeco_javacpp_americano_00024NCCLVector_get(JNIEnv* env, jobject obj, jlong arg0) {
    ::std::vector<caffe::FloatNCCL*>* ptr = (::std::vector<caffe::FloatNCCL*>*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 17), "This pointer address is NULL.");
        return 0;
    }
...
JNIEXPORT jobject JNICALL Java_org_bytedeco_javacpp_americano_00024NCCLVector_put__Lorg_bytedeco_javacpp_americano_00024NCCLVector_2(JNIEnv* env, jobject obj, jobject arg0) {
    ::std::vector<caffe::FloatNCCL*>* ptr = (::std::vector<caffe::FloatNCCL*>*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 17), "This pointer address is NULL.");
        return 0;
    ...
    ptr0 += position0;
    jobject rarg = NULL;
    ::std::vector<caffe::FloatNCCL*>* rptr;
    jthrowable exc = NULL;
    try {
        rptr = &((*ptr)=(*ptr0));
        if (rptr == ptr) {
...
JNIEXPORT jobject JNICALL Java_org_bytedeco_javacpp_americano_00024NCCLVector_put__JLorg_bytedeco_javacpp_americano_00024FloatNCCL_2(JNIEnv* env, jobject obj, jlong arg0, jobject arg1) {
    ::std::vector<caffe::FloatNCCL*>* ptr = (::std::vector<caffe::FloatNCCL*>*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 17), "This pointer address is NULL.");
        return 0;
    ...
    jlong position = env->GetLongField(obj, JavaCPP_positionFID);
    ptr += position;
    ::caffe::FloatNCCL* ptr1 = arg1 == NULL ? NULL : (::caffe::FloatNCCL*)jlong_to_ptr(env->GetLongField(arg1, JavaCPP_addressFID));
    jlong position1 = arg1 == NULL ? 0 : env->GetLongField(arg1, JavaCPP_positionFID);
    ptr1 += position1;
    jobject rarg = obj;
...
JNIEXPORT jlong JNICALL Java_org_bytedeco_javacpp_americano_00024NCCLVector_size(JNIEnv* env, jobject obj) {
    ::std::vector<caffe::FloatNCCL*>* ptr = (::std::vector<caffe::FloatNCCL*>*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 17), "This pointer address is NULL.");
        return 0;
...
JNIEXPORT void JNICALL Java_org_bytedeco_javacpp_americano_00024NCCLVector_resize(JNIEnv* env, jobject obj, jlong arg0) {
    ::std::vector<caffe::FloatNCCL*>* ptr = (::std::vector<caffe::FloatNCCL*>*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 17), "This pointer address is NULL.");
        return;
...
JNIEXPORT void JNICALL Java_org_bytedeco_javacpp_americano_00024NCCLVector_allocate__J(JNIEnv* env, jobject obj, jlong arg0) {
    jthrowable exc = NULL;
    try {
        ::std::vector<caffe::FloatNCCL*>* rptr = new ::std::vector<caffe::FloatNCCL*>((size_t)arg0);
        jlong rcapacity = 1;
        JavaCPP_initPointer(env, obj, rptr, rcapacity, rptr, &JavaCPP_org_bytedeco_javacpp_americano_00024NCCLVector_deallocate);
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
...
JNIEXPORT void JNICALL Java_org_bytedeco_javacpp_americano_00024NCCLVector_allocate__(JNIEnv* env, jobject obj) {
    jthrowable exc = NULL;
    try {
        ::std::vector<caffe::FloatNCCL*>* rptr = new ::std::vector<caffe::FloatNCCL*>();
        jlong rcapacity = 1;
        JavaCPP_initPointer(env, obj, rptr, rcapacity, rptr, &JavaCPP_org_bytedeco_javacpp_americano_00024NCCLVector_deallocate);
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
...
JNIEXPORT void JNICALL Java_org_bytedeco_javacpp_americano_sigstop(JNIEnv* env, jclass cls) {
    jthrowable exc = NULL;
    try {
        caffe::sigstop();
    } catch (...) {
...
JNIEXPORT jint JNICALL Java_org_bytedeco_javacpp_americano_ptr_1device___3F(JNIEnv* env, jclass cls, jfloatArray arg0) {
    float* ptr0 = arg0 == NULL ? NULL : env->GetFloatArrayElements(arg0, NULL);
    jint rarg = 0;
    jthrowable exc = NULL;
    try {
        int rvalue = caffe::ptr_device(ptr0);
        rarg = (jint)rvalue;
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
...
JNIEXPORT jint JNICALL Java_org_bytedeco_javacpp_americano_ptr_1device__Ljava_nio_FloatBuffer_2(JNIEnv* env, jclass cls, jobject arg0) {
    ...
    if (arr0 != NULL) env->ReleaseFloatArrayElements(arr0, (jfloat*)ptr0, 0);
    if (exc != NULL) {
        env->Throw(exc);
    }
    return rarg;
}
JNIEXPORT jint JNICALL Java_org_bytedeco_javacpp_americano_ptr_1device__Lorg_bytedeco_javacpp_FloatPointer_2(JNIEnv* env, jclass cls, jobject arg0) {
...
JNIEXPORT jint JNICALL Java_org_bytedeco_javacpp_americano_get_1device(JNIEnv* env, jclass cls) {
    jint rarg = 0;
    jthrowable exc = NULL;
    try {
        int rvalue = caffe::get_device();
        rarg = (jint)rvalue;
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
...
JNIEXPORT void JNICALL Java_org_bytedeco_javacpp_americano_set_1device(JNIEnv* env, jclass cls, jint arg0) {
    jthrowable exc = NULL;
    try {
        caffe::set_device(arg0);
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
...
JNIEXPORT jint JNICALL Java_org_bytedeco_javacpp_americano_device_1count(JNIEnv* env, jclass cls) {
    jint rarg = 0;
    jthrowable exc = NULL;
    try {
        int rvalue = caffe::device_count();
        rarg = (jint)rvalue;
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
...
JNIEXPORT void JNICALL Java_org_bytedeco_javacpp_americano_installFailureSignalHandler(JNIEnv* env, jclass cls) {
    jthrowable exc = NULL;
    try {
        caffe::installFailureSignalHandler();
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
