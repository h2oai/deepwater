...
# https://raw.githubusercontent.com/apache/spark/master/python/pyspark/daemon.py
...
def worker_main(infile, outfile):
  grpc_service.serve(infile, outfile)
...
def manager():
  ...
  reuse = os.environ.get("DEEPWATER_REUSE_WORKER")
